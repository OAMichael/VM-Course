...
```
cat ../../frontend/Tests/squareEq.lang | ./VMFrontend squareEq
```

#### Second version of frontend is without Flex & Bison. But it does not work properly by now (Lexer is working and Parser buggy). Should not use it by now