...
FUNC MAIN: 0
    ...
    MVI x2, 42
    MVI x3, 2.71
    LOAD_FIELD x2, TestClassInner.intVal
    LOAD_FIELD x3, TestClassInner.floatVal
    STORE_ACC x2
    ...
    LOAD_ACC x4
    LOAD_FIELD x2, TestClassOuter.innerVal

    STORE_FIELD x5, TestClassOuter.innerVal
    LOAD_ACC x5
    STORE_FIELD x1 TestClassInner.intVal
    STORE_FIELD x2 TestClassInner.floatVal
